...
投稿番号：#0001
日付：2026-06-29
対応するnote記事：drafts/note-2026-06-29-ai-output-acceptance-criteria.md
```
...
数字で見るとよく分かります。（縛り1：数字3つ）

AI出力の1/3以上に何らかの誤りが含まれている、という研究があります。でも同時に、「誤り」かどうかを判断できるのは正解を知っている人だけなんです。

合格基準を持っていない人は、1/3どころか、100%のAI出力を正しく評価できない。

そして、ある調査では72%のマネジャーが「部下はAIに価値を失うと恐れている」と感じていると答えています。でも同時に、マネジャー自身も「どこまで信用していいかわからない」と言っている。評価できる人がいないまま、組織でAIが使われている。
...
- 今日の縛り（余り1＋4）：数字3つ（1/3・100%・72%）／結論を中盤に置く
